...
.LFB135:
	...
	.loc 1 35 6 is_stmt 0 view .LVU6
	testl	%edi, %edi
	je	.L2
...
.LBE32:
.LBE33:
	.loc 1 48 3 is_stmt 1 view .LVU17
	movl	%ebp, %edi
	call	exit@PLT
.LVL6:
.L2:
	.loc 1 39 7 view .LVU18
...
.LBE63:
.LBE64:
	.loc 1 40 7 is_stmt 1 view .LVU29
	movq	stdout(%rip), %r12
	movl	$5, %edx
	xorl	%edi, %edi
	leaq	.LC5(%rip), %rsi
...
.LFB136:
	.loc 1 53 1 view -0
	.cfi_startproc
	.loc 1 53 1 is_stmt 0 view .LVU119
	endbr64
	.loc 1 54 3 is_stmt 1 view .LVU120
	.loc 1 56 33 view .LVU121
	.loc 1 57 3 view .LVU122
	.loc 1 53 1 is_stmt 0 view .LVU123
	pushq	%r12
	.cfi_def_cfa_offset 16
	.cfi_offset 12, -16
	pushq	%rbp
...
.LVL55:
	.loc 1 58 3 is_stmt 1 view .LVU127
	leaq	.LC2(%rip), %rsi
	movl	$6, %edi
	call	setlocale@PLT
.LVL56:
	.loc 1 59 3 view .LVU128
	leaq	.LC24(%rip), %rsi
	leaq	.LC10(%rip), %rdi
	call	bindtextdomain@PLT
.LVL57:
	.loc 1 60 3 view .LVU129
	leaq	.LC10(%rip), %rdi
	call	textdomain@PLT
.LVL58:
	.loc 1 62 3 view .LVU130
	movq	close_stdout@GOTPCREL(%rip), %rdi
	call	atexit@PLT
.LVL59:
	.loc 1 64 3 view .LVU131
	movl	$1, %r9d
	movq	%rbx, %rsi
	movl	%ebp, %edi
	subq	$8, %rsp
...
.LVL60:
	.loc 1 68 3 view .LVU132
	.loc 1 68 14 is_stmt 0 view .LVU133
	movslq	optind(%rip), %rax
	.loc 1 68 6 view .LVU134
	addq	$32, %rsp
	.cfi_def_cfa_offset 32
	cmpl	%ebp, %eax
	jl	.L34
	.loc 1 76 3 is_stmt 1 view .LVU135
	.loc 1 76 8 is_stmt 0 view .LVU136
	call	getlogin@PLT
.LVL61:
	movq	%rax, %rdi
.LVL62:
	.loc 1 77 3 is_stmt 1 view .LVU137
	.loc 1 77 6 is_stmt 0 view .LVU138
	testq	%rax, %rax
	je	.L35
	.loc 1 80 3 is_stmt 1 view .LVU139
	call	puts@PLT
.LVL63:
	.loc 1 81 3 view .LVU140
	.loc 1 82 1 is_stmt 0 view .LVU141
	popq	%rbx
	.cfi_remember_state
	.cfi_def_cfa_offset 24
.LVL64:
	.loc 1 82 1 view .LVU142
	xorl	%eax, %eax
	popq	%rbp
	.cfi_def_cfa_offset 16
.LVL65:
	.loc 1 82 1 view .LVU143
	popq	%r12
...
.L34:
	.cfi_restore_state
	.loc 1 70 7 is_stmt 1 view .LVU144
	movq	(%rbx,%rax,8), %rdi
	call	quote@PLT
.LVL67:
	.loc 1 70 20 is_stmt 0 view .LVU145
	movl	$5, %edx
	leaq	.LC26(%rip), %rsi
	xorl	%edi, %edi
	.loc 1 70 7 view .LVU146
	movq	%rax, %r12
	.loc 1 70 20 view .LVU147
	call	dcgettext@PLT
.LVL68:
	.loc 1 70 7 view .LVU148
	xorl	%edi, %edi
	movq	%r12, %rcx
	xorl	%esi, %esi
	.loc 1 70 20 view .LVU149
	movq	%rax, %rdx
	.loc 1 70 7 view .LVU150
	xorl	%eax, %eax
	call	error@PLT
.LVL69:
	.loc 1 71 7 is_stmt 1 view .LVU151
	movl	$1, %edi
	call	usage
.LVL70:
.L35:
.LBB66:
	.loc 1 78 5 view .LVU152
	movl	$5, %edx
	leaq	.LC27(%rip), %rsi
	call	dcgettext@PLT
.LVL71:
	.loc 1 78 5 is_stmt 0 view .LVU153
	xorl	%esi, %esi
	movl	$1, %edi
	movq	%rax, %rdx
	xorl	%eax, %eax
