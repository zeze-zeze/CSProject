...
.LC3:
	...
	.align 8
.LC4:
	.string	"Usage: %s FILE1 FILE2\n  or:  %s OPTION\n"
	.align 8
.LC5:
	.string	"Call the link function to create a link named FILE2 to an existing FILE1.\n\n"
	.align 8
.LC6:
...
.LC29:
	.string	"cannot create link %s to %s"
...
.LVL60:
	...
	.loc 1 73 12 is_stmt 0 view .LVU131
	movslq	optind(%rip), %rax
	.loc 1 73 6 view .LVU132
	addq	$32, %rsp
	.cfi_def_cfa_offset 48
	.loc 1 73 12 view .LVU133
	leal	1(%rax), %edx
	.loc 1 73 6 view .LVU134
	cmpl	%ebp, %edx
	jge	.L38
	.loc 1 82 3 is_stmt 1 view .LVU135
	movslq	%eax, %rdx
	.loc 1 82 14 is_stmt 0 view .LVU136
	addl	$2, %eax
	.loc 1 82 6 view .LVU137
	cmpl	%ebp, %eax
	jl	.L39
	.loc 1 88 3 is_stmt 1 view .LVU138
	.loc 1 88 31 is_stmt 0 view .LVU139
	leaq	1(%rdx), %rax
	.loc 1 88 7 view .LVU140
	movq	(%rbx,%rax,8), %rsi
	movq	-8(%rbx,%rax,8), %rdi
	call	link@PLT
.LVL61:
	.loc 1 88 6 view .LVU141
	testl	%eax, %eax
	jne	.L40
	.loc 1 92 3 is_stmt 1 view .LVU142
	.loc 1 93 1 is_stmt 0 view .LVU143
	addq	$8, %rsp
	.cfi_remember_state
	.cfi_def_cfa_offset 40
	xorl	%eax, %eax
	...
	.cfi_def_cfa_offset 32
.LVL62:
	.loc 1 93 1 view .LVU144
	popq	%rbp
	.cfi_def_cfa_offset 24
.LVL63:
	.loc 1 93 1 view .LVU145
	popq	%r12
	.cfi_def_cfa_offset 16
	popq	%r13
...
.L38:
	.cfi_restore_state
	.loc 1 75 7 is_stmt 1 view .LVU146
	.loc 1 75 10 is_stmt 0 view .LVU147
	cmpl	%ebp, %eax
	jl	.L32
	.loc 1 76 9 is_stmt 1 view .LVU148
	.loc 1 76 22 is_stmt 0 view .LVU149
	movl	$5, %edx
	leaq	.LC26(%rip), %rsi
	xorl	%edi, %edi
	call	dcgettext@PLT
.LVL65:
	.loc 1 76 9 view .LVU150
	xorl	%esi, %esi
	xorl	%edi, %edi
	.loc 1 76 22 view .LVU151
	movq	%rax, %rdx
...
.LVL66:
.L33:
	.loc 1 79 7 is_stmt 1 view .LVU153
	movl	$1, %edi
	call	usage
.LVL67:
.L40:
.LBB66:
	.loc 1 89 5 view .LVU154
	movslq	optind(%rip), %rax
	movl	$4, %esi
	movl	$1, %edi
	movq	(%rbx,%rax,8), %rdx
...
.LVL68:
	...
	movq	%rax, %rbp
.LVL69:
	.loc 1 89 5 is_stmt 0 view .LVU155
	movslq	optind(%rip), %rax
...
.LVL73:
.L39:
	.loc 1 89 5 view .LVU156
.LBE66:
	.loc 1 84 7 is_stmt 1 view .LVU157
	movq	16(%rbx,%rdx,8), %rdi
	call	quote@PLT
.LVL74:
	.loc 1 84 20 is_stmt 0 view .LVU158
	movl	$5, %edx
	leaq	.LC28(%rip), %rsi
	.loc 1 84 7 view .LVU159
	movq	%rax, %r12
.L37:
	.loc 1 78 22 view .LVU160
	xorl	%edi, %edi
	call	dcgettext@PLT
.LVL75:
	.loc 1 78 9 view .LVU161
	movq	%r12, %rcx
	xorl	%esi, %esi
	xorl	%edi, %edi
	.loc 1 78 22 view .LVU162
	movq	%rax, %rdx
	.loc 1 78 9 view .LVU163
	xorl	%eax, %eax
	call	error@PLT
.LVL76:
	jmp	.L33
.L32:
	.loc 1 78 9 is_stmt 1 view .LVU164
	movq	(%rbx,%rax,8), %rdi
	call	quote@PLT
.LVL77:
	.loc 1 78 22 is_stmt 0 view .LVU165
	movl	$5, %edx
	leaq	.LC27(%rip), %rsi
	.loc 1 78 9 view .LVU166
	movq	%rax, %r12
	jmp	.L37
	.cfi_endproc
.LFE136:
