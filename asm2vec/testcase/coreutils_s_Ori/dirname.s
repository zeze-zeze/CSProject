...
.L24:
	...
	cmpb	$0, -21(%rbp)
	je	.L25
	.loc 2 132 7 is_stmt 0 discriminator 1
	movl	$0, %eax
	jmp	.L26
.L25:
...
.L26:
	...
	.loc 2 120 31 is_stmt 1 discriminator 4
	movl	optind(%rip), %eax
	addl	$1, %eax
	movl	%eax, optind(%rip)
.L23:
	.loc 2 120 17 discriminator 1
	movl	optind(%rip), %eax
